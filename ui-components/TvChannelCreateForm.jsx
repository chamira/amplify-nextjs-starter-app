...
import { createTvChannel } from "./graphql/mutations";
const client = generateClient();
export default function TvChannelCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setChannelAppImageName(initialValues.channelAppImageName);
    setChannelWebImageName(initialValues.channelWebImageName);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createTvChannel.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "TvChannelCreateForm")}
      {...rest}
    >
      <TextField
        label="Channel id"
